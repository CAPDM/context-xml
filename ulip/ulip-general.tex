...
\startxmlsetups xml:capdm:base
 ...
 \xmlsetfunction {\xmldocument}{tbody}{userdata.xmlfunctions.tbody}
...
\setupTABLE[offset=.3em,frame=off,split=yes,width=broad]
...
\startxmlsetups xml:capdm:tgroup
 % reset global colspec attribute values for use in table lua functions
 \startluacode
  tablecolspecalign = {}
  tablecolspecname = {}
  tablecolspecwidth = {}
